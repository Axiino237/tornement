    ...
    if (empty($tournament_name) || empty($game_name) || empty($tournament_date) || empty($max_players)) {
        ...
        if ($completed_count < 2 && !$tournament['is_paid'] && !$is_admin) {
            ...
            if ($stmt->execute([$tournament_name, $game_name, $tournament_date, 
                ...
                $is_paid, $registration_fee, $prize_style, $winning_prize, $second_prize, $third_prize, $per_kill_prize, $contact_info, $auto_approval, $banner_url, $_GET['id'], $_SESSION['user_id']])) {
            ...
            <div class="card-body">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <?php if ($tournament['banner_url']): ?>
                            <div class="mb-2">
                                <img src="/<?php echo $tournament['banner_url']; ?>" alt="Current Banner" class="img-thumbnail" style="max-height: 100px;">
                            </div>
                        <?php endif; ?>
                        <input type="file" class="form-control" id="tournament_banner" name="tournament_banner" accept="image/*">
                        <small class="text-muted">Upload a new banner to change it. Leave empty to keep the current one.</small>
                    </div>
