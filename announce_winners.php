                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="position" name="position" required>
                                ...
                                <option value="1">1st Place (Winner/Booyah)</option>
                                    ...
                                    <?php if ($tournament['is_paid']): ?>
                                        <div class="text-end">
                                            <small class="text-success">₹<?php 
                                                if($winner['position'] == 1) echo number_format($tournament['winning_prize'], 2);
                                                elseif($winner['position'] == 2) echo number_format($tournament['second_prize'], 2);
                                                elseif($winner['position'] == 3) echo number_format($tournament['third_prize'], 2);
                                                else echo '0.00';
                                            ?></small>
                                        </div>
                                    <?php endif; ?>
