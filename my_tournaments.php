                                                ...
                                                <?php if ($tournament['status'] == 'active'): ?>
                                                    <?php if ($tournament['current_participants'] == 0): ?>
                                                        <a href="edit_tournament.php?id=<?php echo $tournament['tournament_id']; ?>" 
                                                           class="btn btn-sm btn-info" title="Edit Tournament" data-bs-toggle="tooltip">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    <?php else: ?>
                                                        <button class="btn btn-sm btn-info" title="Cannot edit after players join" data-bs-toggle="tooltip" disabled>
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                    <?php endif; ?>
